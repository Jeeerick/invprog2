$(document).ready(function() {
	...
	$('#report_window').on('shown.bs.modal', function () {
		...
		report.location="print_purchase.php?purchase_id="+$("#purchase_id").val();
	});
...
function DeleteDetail(nIndex) {
	...
	$.ajax({
		type: "POST",
		url: "./remove_purchase_detail.php",
		data: "index="+nIndex,
		success: function(text) {
			$("#message").addClass("hidden");
			if ( text != "" )
...
function LoadDetails() {
	...
	$.ajax({
        type: "POST",
        url: "./load_purchase_details.php",
        data: ""
        ,
        success : function(text) {
			$("#details").html(text);			
			$("#message").addClass("hidden");
			location="#purchase_bottom";
