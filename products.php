		...
		<div class="container-fluid"> <!-- Container DIV for BOOTSTRAP -->
			...
			<div class="rows">
				...
				<div class="col-sm-6">
					...
					<h2>Products</h2>
					Product Code:&nbsp;<input type="text" size="10" maxlength="10" disabled="true" id="product_code"><br><br>
					Description:&nbsp;<input type="text" size="50" maxlength="100" disabled="true" id="description"><br><br>
					Price:&nbsp;<input type="text" size="10" maxlength="10" disabled="true" class="text-right" id="price" value="0"><br><br>
					Cost:&nbsp;<input type="text" size="10" maxlength="10" disabled="true" class="text-right" id="cost" value="0"><br><br>
					Beginning Quantity:&nbsp;<input type="text" size="10" maxlength="10" disabled="true" class="text-right" id="beginning_qty" value="0"><br><br>
					Category:&nbsp;<select disabled="true" id="category_id"></select><br><br>
