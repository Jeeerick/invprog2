...
for ( $i = 0; $i < count($_SESSION["sale_details"]); $i++ ) {
	...
	$nT = round($_SESSION["sale_details"][$i][2]*$_SESSION["sale_details"][$i][3],2);
	$cH .= "<tr class='details' >
				<td>".($i+1).".</td>
				<td>".$_SESSION["sale_details"][$i][1]."</td>
				<td align='center'>".$_SESSION["sale_details"][$i][2]."</td>
				<td align='right'>".number_format($_SESSION["sale_details"][$i][3],2)."</td>
